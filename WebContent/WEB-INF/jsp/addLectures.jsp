...
Ankita Singh
  ...
  <div class="content">
      ...
      <div class="leftbox" style="margin-bottom:20px;"><img src="Style/images/userpic.gif" alt="" width="104" height="87" align="left"  style=" margin:0 20px 0 0;"/>
        <p > <a href="#">By Creater Name</a><br />
          <a href="#">Category:Art</a><br />
          <a href="#">Tags:</a><br />
        </p>
      </div>
          ...
          <ul style=" list-style:none;">
            <li>
              ...
              <div style="margin-left:30px;">
                <ol id="add-content">
                  <li>
                    <h4><a href="uploadForm.html">Upload a Video</a></h4>
